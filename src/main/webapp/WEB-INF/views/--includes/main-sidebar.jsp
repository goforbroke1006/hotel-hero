...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-edit"></i> <span>Миграционный учет</span>
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-edit"></i> <span>Оплаты</span>
                    <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-edit"></i> <span>Принимающая сторона</span>
                    <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="/receiving-point/list"><i class="fa fa-circle-o"></i>Список</a></li>
                </ul>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="/registration-form/"><i class="fa fa-circle-o"></i> Registration form</a></li>
